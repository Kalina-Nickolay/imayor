...
public class StoreButton {
    ...
    public StoreButton(final IMayor game, MenuState menustate) {
        this.game = game;
        this.set = game.set;
        this.res = game.res;
        this.card = game.card;
        ...
        imageButtonStyle.up = skin.getDrawable("StoreButton-up");
        imageButtonStyle.down = skin.getDrawable("StoreButton-down");
        imageButtonStyle.checked = skin.getDrawable("StoreButton-up");
    ...
    public void resize() {
        ...
        button.setPosition(res.width/2 - res.width*5/14, res.height/2 - res.width*2/7);
    }
}